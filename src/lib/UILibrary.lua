...
local function TweenTransparency(Object, Property)
	local Tween = game:GetService("TweenService"):Create(Object, TweenInfo.new(Property["Time"]), {Transparency= Property["Transparency"]}):Play()
	return Tween
end
local function TweenBackgroundTransparency(Object, Property)
	local Tween = game:GetService("TweenService"):Create(Object, TweenInfo.new(Property["Time"]), {BackgroundTransparency= Property["BackgroundTransparency"]}):Play()
	return Tween
end
local function TweenImageTransparency(Object, Property)
	local Tween = game:GetService("TweenService"):Create(Object, TweenInfo.new(Property["Time"]), {ImageTransparency= Property["ImageTransparency"]}):Play()
	return Tween
end
local function TweenTextTransparency(Object, Property)
	local Tween = game:GetService("TweenService"):Create(Object, TweenInfo.new(Property["Time"]), {TextTransparency= Property["TextTransparency"]}):Play()
	return Tween
end
...
function Library:Create(Name, StartupText, Color)
	local Color = Color or Color3.fromRGB(247, 83, 91)
	local GelatekUI = Instance.new("ScreenGui")
	...
	local OffsetFixer = Instance.new("TextLabel")	
	...
	Main.Size = UDim2.new(0, 375, 0, 267)
	...
	Title.Size = UDim2.new(0, 168, 0, 29)
	Title.Font = Enum.Font.GothamMedium
	Title.Text = Name or "Gelatek UI"
	Title.TextColor3 = Color or Color3.fromRGB(247, 83, 91)
	...
	Exit.Position = UDim2.new(0.938666642, 0, 0.0262172278, 0)
	...
	LineSide.Position = UDim2.new(0.301333338, 0, 0.10899999, 0)
	LineSide.Size = UDim2.new(0, 1, 0, 237)
	LineSide.Font = Enum.Font.SourceSans
	LineSide.Text = " "
	LineSide.TextColor3 = Color3.fromRGB(0, 0, 0)
	LineSide.TextSize = 14.000
	
	LineTop.Name = "LineTop"
	LineTop.BackgroundColor3 = Color3.fromRGB(54, 54, 54)
	LineTop.BackgroundTransparency = 1.000
	LineTop.BorderSizePixel = 0
	LineTop.Position = UDim2.new(0, 0, 0.104868911, 0)
	LineTop.Size = UDim2.new(0, 375, 0, 1)
	LineTop.Font = Enum.Font.SourceSans
	LineTop.Text = " "
	LineTop.TextColor3 = Color3.fromRGB(0, 0, 0)
	...
	TabList.Position = UDim2.new(0, 0, 0.112745307, 0)
	TabList.Size = UDim2.new(0, 0, 0, 235)
	...
	OffsetFixer.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	OffsetFixer.BackgroundTransparency = 1.000
	OffsetFixer.Position = UDim2.new(0.0663716793, 0, 1.2986203e-07, 0)
	OffsetFixer.Size = UDim2.new(0, 105, 0, 2)
	OffsetFixer.Font = Enum.Font.SourceSans
	OffsetFixer.Text = " "
	OffsetFixer.TextColor3 = Color3.fromRGB(0, 0, 0)
	OffsetFixer.TextSize = 14.000

	Shadow.Name = "Shadow"
	Shadow.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	Shadow.BackgroundTransparency = 1.000
	Shadow.Position = UDim2.new(-0.0533333346, 0, -0.0557678454, 0)
	Shadow.Rotation = 0.001
	Shadow.Size = UDim2.new(0, 415, 0, 296)
	Shadow.ZIndex = -1
	...
	Logo.Position = UDim2.new(0.298999995, 0, -0.670000017, 0)
	...
	Credit.Position = UDim2.new(-0.166666672, 0, 1.05999994, 0)
	...
	Drag.Size = UDim2.new(0, 375, 0, 29)
	...
	task.spawn(function()
		...
		wait(1.5)
		Logo:TweenPosition(UDim2.new(0.299,0,1,0), Enum.EasingDirection.InOut, Enum.EasingStyle.Quint, 0.5)
		wait(0.6)
	...
	function LibraryTabs:MakeTab(Name)
		...
		TabButton.Position = UDim2.new(0.0663716793, 0, 0.0212767255, 0)
		TabButton.Size = UDim2.new(0, 98, 0, 23)
		TabButton.Font = Enum.Font.GothamMedium
		TabButton.Text = Name or "Tab"
		TabButton.TextColor3 = Color3.fromRGB(217, 217, 217)
		...
		Tab.Position = UDim2.new(0.30399999, 0, 0.131086141, 0)
		Tab.Size = UDim2.new(0, 253, 0, 231)
		Tab.Visible = false
		Tab.ScrollBarThickness = 1
		Tab.CanvasSize = UDim2.new(0,1,0,0)
		...
		function LibraryItems:MakeLabel(Text)
			...
			Label.Position = UDim2.new(-0.272727281, 0, 0.00749063678, 0)
			Label.Size = UDim2.new(0, 238, 0, 30)

			LabelText.Name = "LabelText"
			LabelText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			LabelText.BackgroundTransparency = 1.000
			LabelText.Position = UDim2.new(0.045363225, 0, 0, 0)
			LabelText.Size = UDim2.new(0, 219, 0, 30)
			LabelText.Font = Enum.Font.GothamMedium
			LabelText.Text = Text or "Fun Fact: 127.0.0.1 Is a local IP."
			LabelText.TextColor3 = Color3.fromRGB(211, 211, 211)
		...
		function LibraryItems:MakeButton(Text, Call)
			...
			Button.Position = UDim2.new(0.0296442695, 0, 0, 0)
			Button.Size = UDim2.new(0, 238, 0, 30)
			...
			ButtonText.Position = UDim2.new(0.045363225, 0, 0, 0)
			ButtonText.Size = UDim2.new(0, 219, 0, 30)
			ButtonText.Font = Enum.Font.GothamMedium
			ButtonText.Text = Text or "Hello"
			ButtonText.TextColor3 = Color3.fromRGB(211, 211, 211)
		...
		function LibraryItems:MakeToggle(Text, Call)
			...
			local ToggleCheckStroke = Instance.new("UIStroke")
			
			Toggle.Name = "Toggle"
			Toggle.BackgroundColor3 = Color3.fromRGB(44, 44, 44)
			Toggle.Position = UDim2.new(0.0296442695, 0, 0, 0)
			Toggle.Size = UDim2.new(0, 238, 0, 30)
			...
			ToggleText.Position = UDim2.new(0.045363225, 0, 0, 0)
			ToggleText.Size = UDim2.new(0, 198, 0, 30)
			ToggleText.Font = Enum.Font.GothamMedium
			ToggleText.Text = Text or "Do you like me?"
			ToggleText.TextColor3 = Color3.fromRGB(211, 211, 211)
			...
			ToggleCheck.Position = UDim2.new(0.902506053, 0, 0.170100912, 0)
			ToggleCheck.Size = UDim2.new(0, 19, 0, 19)
			...
			ToggleCheckStroke.Color = Color3.fromRGB(13, 13, 13)
		...
		function LibraryItems:MakeTextBox(Text, Call)
			...
			local TextboxMainTextSize = Instance.new("UITextSizeConstraint")
			
			Textbox.Name = "Textbox"
			Textbox.BackgroundColor3 = Color3.fromRGB(44, 44, 44)
			Textbox.Position = UDim2.new(-0.272727281, 0, 0.00749063678, 0)
			Textbox.Size = UDim2.new(0, 238, 0, 30)

			TextboxLabel.Name = "TextboxLabel"
			TextboxLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			TextboxLabel.BackgroundTransparency = 1.000
			TextboxLabel.Position = UDim2.new(0.045363225, 0, 0, 0)
			TextboxLabel.Size = UDim2.new(0, 157, 0, 30)
			TextboxLabel.Font = Enum.Font.GothamMedium
			TextboxLabel.Text = Text or "Enter your code"
			TextboxLabel.TextColor3 = Color3.fromRGB(211, 211, 211)
			...
			TextboxMain.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			TextboxMain.Position = UDim2.new(0.705027103, 0, 0.199393719, 0)
			TextboxMain.Size = UDim2.new(0, 64, 0, 18)
			TextboxMain.Font = Enum.Font.GothamMedium
			TextboxMain.Text = ""
			TextboxMain.TextColor3 = Color3.fromRGB(212, 212, 212)
		...
		function LibraryItems:MakeSlider(Name, Minimum, Maximum, Call)
			...
			Slider.Position = UDim2.new(-0.0335968323, 0, 0.411717504, 0)
			Slider.Size = UDim2.new(0, 238, 0, 40)

			SliderText.Name = "SliderText"
			SliderText.Parent = Slider
			SliderText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			SliderText.BackgroundTransparency = 1.000
			SliderText.Position = UDim2.new(0.045363225, 0, 0.100000001, 0)
			SliderText.Size = UDim2.new(0, 198, 0, 19)
			SliderText.Font = Enum.Font.GothamMedium
			SliderText.Text = Name or "Slide for fun!"
			SliderText.TextColor3 = Color3.fromRGB(211, 211, 211)
			...
			SliderMain.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			SliderMain.BorderSizePixel = 0
			SliderMain.Position = UDim2.new(0.0340000018, 0, 0.600000024, 0)
			SliderMain.Size = UDim2.new(0, 221, 0, 10)
			...
			SliderLine.Position = UDim2.new(2.7617719e-07, 0, 0, 0)
			SliderLine.Size = UDim2.new(0, 0, 0, 10)

			SliderLineCorner.CornerRadius = UDim.new(0, 3)
			SliderLineCorner.Name = "SliderLineCorner"
			 
			SliderLineGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(88, 88, 88))}
			SliderLineGradient.Name = "SliderLineGradient"

			SliderValue.Name = "SliderValue"
			SliderValue.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			SliderValue.BackgroundTransparency = 1.000
			SliderValue.Position = UDim2.new(0.877295971, 0, 0.163274378, 0)
			SliderValue.Size = UDim2.new(0, 24, 0, 12)
			SliderValue.Font = Enum.Font.GothamMedium
			SliderValue.Text = tostring(MinimumValue)
			SliderValue.TextColor3 = Color3.fromRGB(211, 211, 211)
			...
			SliderMain.MouseButton1Down:Connect(function()
				...
				SliderLine.Size = UDim2.new(0, math.clamp(Mouse.X - SliderLine.AbsolutePosition.X, 0, 221), 0, 10)
		...
		function LibraryItems:MakeDropdown(Name, Table, Call)
			...
			local Callback = Call or function() end
			local Size = UDim2.new(0, 238, 0, 0)
			...
			local DropdownMainList = Instance.new("UIListLayout")
			local DropdownMainCorner = Instance.new("UICorner")
			
			Dropdown.Name = "Dropdown"
			Dropdown.BackgroundColor3 = Color3.fromRGB(44, 44, 44)
			Dropdown.Position = UDim2.new(-0.272727281, 0, 0.00749063678, 0)
			Dropdown.Size = UDim2.new(0, 238, 0, 30)

			DropdownLabel.Name = "DropdownLabel"
			DropdownLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			DropdownLabel.BackgroundTransparency = 1.000
			DropdownLabel.Position = UDim2.new(0.045363225, 0, 0, 0)
			DropdownLabel.Size = UDim2.new(0, 157, 0, 30)
			DropdownLabel.Font = Enum.Font.GothamMedium
			DropdownLabel.Text = Name or "Select Your Team"
			DropdownLabel.TextColor3 = Color3.fromRGB(211, 211, 211)
			...
			Opener.Name = "Opener"
			Opener.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			Opener.Position = UDim2.new(0.705027103, 0, 0.200000003, 0)
			Opener.Size = UDim2.new(0, 64, 0, 18)
			Opener.Font = Enum.Font.GothamMedium
			Opener.Text = "Select"
			Opener.TextColor3 = Color3.fromRGB(211, 211, 211)
			...
			DropdownMain.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			DropdownMain.BorderSizePixel = 0
			DropdownMain.ClipsDescendants = true
			DropdownMain.Position = UDim2.new(-2.6218195, 0, 1.28526819, 0)
			DropdownMain.Size = UDim2.new(0, 238, 0, 0)
			...
			for i,v in next, TableInfo do
				...
				Option.Position = UDim2.new(0.115546219, 0, 0, 0)
				Option.Size = UDim2.new(0, 181, 0, 18)
				Option.ZIndex = 2
				Option.Font = Enum.Font.GothamMedium
				Option.Text = v
				Option.TextColor3 = Color3.fromRGB(211, 211, 211)
				...
				Size = Size + UDim2.new(0, 0, 0, 20)
				Option.MouseButton1Down:Connect(function()
					Opener.Text = v
					Callback(v)
					DropdownMain:TweenSize(UDim2.new(0, 238, 0, 0), Enum.EasingDirection.In, Enum.EasingStyle.Quad, 0.2, false)
				end)
			end
			Opener.MouseButton1Down:Connect(function()
				if DropdownMain.Size == UDim2.new(0, 238, 0, 0) then
		...
		function LibraryItems:MakeColorPicker(Name, Call)
			...
			local ColorPickerBarGradient = Instance.new("UIGradient")
			local Picker = Instance.new("TextLabel")
			local PickerCorner = Instance.new("UICorner")
			
			ColorPicker.Name = "ColorPicker"
			ColorPicker.BackgroundColor3 = Color3.fromRGB(44, 44, 44)
			ColorPicker.Position = UDim2.new(0.0296442695, 0, 0.251082242, 0)
			ColorPicker.Size = UDim2.new(0, 238, 0, 51)

			ColorPickerTitle.Name = "ColorPickerTitle"
			ColorPickerTitle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			ColorPickerTitle.BackgroundTransparency = 1.000
			ColorPickerTitle.Position = UDim2.new(0.045363225, 0, 0, 0)
			ColorPickerTitle.Size = UDim2.new(0, 219, 0, 30)
			ColorPickerTitle.Font = Enum.Font.GothamMedium
			ColorPickerTitle.Text = Name or "Select Team Color"
			ColorPickerTitle.TextColor3 = Color3.fromRGB(211, 211, 211)
			...
			ColorPickerBar.Position = UDim2.new(0.0252100863, 0, 0.588235319, 0)
			ColorPickerBar.Size = UDim2.new(0, 223, 0, 14)

			ColorPickerBarCorner.CornerRadius = UDim.new(0, 3)
			ColorPickerBarCorner.Name = "ColorPickerBarCorner"

			ColorPickerBarGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 4)), ColorSequenceKeypoint.new(0.12, Color3.fromRGB(255, 130, 47)), ColorSequenceKeypoint.new(0.22, Color3.fromRGB(255, 243, 73)), ColorSequenceKeypoint.new(0.34, Color3.fromRGB(133, 255, 89)), ColorSequenceKeypoint.new(0.45, Color3.fromRGB(108, 255, 182)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(121, 249, 255)), ColorSequenceKeypoint.new(0.61, Color3.fromRGB(144, 168, 255)), ColorSequenceKeypoint.new(0.72, Color3.fromRGB(160, 51, 255)), ColorSequenceKeypoint.new(0.80, Color3.fromRGB(255, 98, 227)), ColorSequenceKeypoint.new(0.88, Color3.fromRGB(139, 76, 47)), ColorSequenceKeypoint.new(0.94, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))}
			ColorPickerBarGradient.Name = "ColorPickerBarGradient"

			Picker.Name = "Picker"
			Picker.BackgroundColor3 = Color3.fromRGB(29, 29, 29)
			Picker.Position = UDim2.new(0.705027103, 0, 0.101960786, 0)
			Picker.Size = UDim2.new(0, 64, 0, 18)
			Picker.Font = Enum.Font.GothamMedium
			Picker.Text = "Preview"
			Picker.TextColor3 = Color3.fromRGB(211, 211, 211)
